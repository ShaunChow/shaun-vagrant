...
cat >>/etc/hosts<<EOF
172.17.8.101 kmaster
172.17.8.102 kworker1
172.17.8.103 kworker2
172.17.8.102 keycloak.shaun.io
EOF
...
yum install -y -q kubeadm-1.15.2 kubelet-1.15.2 kubectl-1.15.2 >/dev/null 2>&1
